...
function EM_user_info($user_id, $mobile) {
	...
	$user_info['address'] = $user_info['address_id'] > 0 ? RC_DB::table('regions')->where('region_id', $address['city'])->pluck('region_name').RC_DB::table('regions')->where('region_id', $address['district'])->pluck('region_name').$address['address'] : '';
