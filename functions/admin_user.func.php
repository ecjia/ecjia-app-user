...
// 	);
	...
	$await_pay =  RC_DB::table('order_info')->where('user_id', $user_id)->where('extension_id', 0)->where('pay_status', PS_UNPAYED)->whereIn('order_status', array(OS_UNCONFIRMED, OS_CONFIRMED, OS_SPLITED))->count();
