	...
	<form class="form-horizontal" id="form-privilege" name="theForm" action="{$form_action}" method="post">
		<fieldset>
			<div class="control-group formSep">
				...
				<div class="controls users l_h30">
					<p>{$user.user_name}</p>
				</div>
			</div>
			<div class="control-group formSep">
				<label class="control-label">{$lang.label_user_money}</label>
				<div class="controls">
					...
					<span>{$lang.current_value}{$user.formated_user_money}</span>
				</div>
			</div>
			<div class="control-group formSep">
				<label class="control-label">{$lang.label_frozen_money}</label>
				<div class="controls">
					...
					<span>{$lang.current_value}{$user.formated_frozen_money}</span>
				</div>
			</div>
			<div class="control-group formSep">
				<label class="control-label">{$lang.label_rank_points}</label>
				<div class="controls">
					...
					<span>{$lang.current_value}{$user.rank_points}</span>
				</div>
			</div>
			<div class="control-group formSep">
				<label class="control-label">{$lang.label_pay_points}</label>
				<div class="controls">
					...
					<span>{$lang.current_value}{$user.pay_points}</span>
				</div>
			</div>
			<!-- 管理员备注  -->
			<div class="control-group formSep">
				<label class="control-label">{$lang.label_change_desc}</label>
				<div class="controls">
