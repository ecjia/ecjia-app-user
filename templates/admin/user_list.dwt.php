				...
				<tr>
					...
					<td class="hide-edit-area">
						...
						<div class="edit-list">
							...
							<!-- &nbsp;|&nbsp; -->
							<!-- <a target="_blank" href='{url path="finance/admin_account_log/user_money" args="user_id={$user.user_id}"}' title="">查看余额变动</a>&nbsp;|&nbsp;
							<a target="_blank" href='{url path="finance/admin_account_log/pay_points" args="user_id={$user.user_id}"}' title="">查看积分变动</a>&nbsp;|&nbsp;
							<a target="_blank" href='{url path="finance/admin_account_log/rank_points" args="user_id={$user.user_id}"}' title="">查看成长值变动</a> -->
